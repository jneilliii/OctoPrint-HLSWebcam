$(function() {
    function HlswebcamViewModel(parameters) {
        ...
        self._enableWebcam = function() {
            if (OctoPrint.coreui.selectedTab != "#tab_plugin_hlswebcam" || !OctoPrint.coreui.browserTabVisible) {
                return;
            }
            ...
            if (streamType == "mjpg") {
                self._enableMjpgWebcam();
            } else if (streamType == "hls") {
                self._enableHlsWebcam();
            } else {
        ...
        self.onTabChange = function (current, previous) {
            if (current == "#tab_plugin_hlswebcam") {
                self._enableWebcam();
            } else if (previous == "#tab_plugin_hlswebcam") {
                self._disableWebcam();
            }
        };
        ...
        self._determine_stream_type = function(streamUrl) {
        ...
        self._enableMjpgWebcam = function() {
        ...
        self._enableHlsWebcam = function() {
    ...
    OCTOPRINT_VIEWMODELS.push({
        ...
        elements: ["#tab_plugin_hlswebcam", "#tab_plugin_hlswebcam_link"]
    });
});
